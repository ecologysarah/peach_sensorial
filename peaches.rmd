...
levels(peach$Ethnic)<-c("Caucasian",	"Asian",	"Hispanic",	"Black",	"Other", "NA")
#Convert "3" to "NA"
...
dev.print(pdf, "./Results/PurchaseCharacteristics.pdf", height=5, width=10)
dev.print(png, "./Results/Fig2.png", height=8, width=5, units="in", res=500)
```
#Liking rating
##Modelling liking
```{r}
