...
#Check assumptions
mod1.check<-clm(as.factor(Rating)~Aroma + Sweet + Acid + Bitter + Astringent + Juicy + Crunchy + Fibrous + Firm + Soft + Mealy + Respondent, data = peachperson, na.action = na.fail)
